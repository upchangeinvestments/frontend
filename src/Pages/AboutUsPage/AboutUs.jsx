  ...
  return (
    <div className="overflow-x-hidden bg-gradient-to-r from-purple-300 to-pink-200 lg:mb-0 vsm:mb-12 md:mb-12">
      <div className="flex vsm:flex vsm:flex-col md:flex md:flex-row md:mt-2 lg:mt-8 relative">
        <div class="lg:ml-[150px] lg:mt-[50px] lg:w-[280px] lg:h-[785px]  bg-[#6e30a7] backdrop-blur-xl bottom-0 flex flex-col items-center rounded-lg font-['Playfair-Display']   rounded-t-full">
          <img
            className="lg:w-[200px] lg:h-[200px] lg:mt-[30px] border-2 border-yellow-500 rounded-full "
            src={Lipika_mam}
            alt="Lipika Sharma"
          />
          <div class="text-center">
            <h2 class="lg:text-[22px] text-white font-semibold lg:mt-[50px] lg:mb-[30px] uppercase">
              Company at a glance
            </h2>
            <div class="flex flex-col items-center">
              <div>
                <p class="lg:text-[20px] text-white font-medium mb-2">
                  FOUNDER
                </p>
                <p class="lg:text-[21px] font-medium lg:mb-[15px]">
                  LIPIKA SHARMA
                </p>
              </div>
              <div class="mb-4">
                ...
                <p class="lg:text-[21px] font-medium mb-2">2024</p>
              </div>
            </div>
          </div>
        </div>
        <div className="vsm:p-4 vsm:w-[90%] vsm:ml-4 vsm:mt-16 md:w-[68%] md:p-8 md:px-10 lg:p-6 lg:w-[60%] lg:ml-[40px] xl:p-4 xl:ml-[50px]  bg-white/20 shadow-2xl shadow-purle-500/50 font-['Playfair-Display']   rounded-lg backdrop-blur-xl relative ">
          ...
          <p className="flex items-center justify-center text-justify lg:text-[20px] vsm:px-4 vsm:mb-6 md:p-4 xl:px-8  lg:mr-0">
      ...
      <div className="mb-[50px]">
        <h2 className="lg:text-[32px] font-bold mt-12 text-center font-['Playfair-Display'] my-8 uppercase text-[#9747FF]">
          Modern Real Estate Investment solutions
        </h2>

        <div className="flex flex-wrap gap-x-12 items-center justify-center w-full">
          <Card className="my-6 border-2 border-purple-500 w-[250px] ">
