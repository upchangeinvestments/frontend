    ...
    <div className="mobile-filter-drawer">
      <div className="categoryMain">
        ...
        <div className="h-[85vh] overflow-hidden flex items-center vsm:justify-center lg:justify-end">
          <p className="uppercase font-['Playfair-Display'] text-white vsm:text-2xl md:text-4xl lg:text-[40px] xl:text-5xl lg:-mt-[350px] lg:mr-[100px] xl:-mt-[430px] xl:mr-[120px] ">
            Explore Categories
          </p>
        </div>
      </div>
