...
function Post({ data, type }) {
  ...
  return (
    <div className=" ">
      <div className="hidden xl:grid grid-cols-2 xl:mx-6 rounded-lg bg-white shadow-2xl shadow-purple-300 p-4">
        <div className="">
          <div className="">
        ...
        <div className="">
          <h3 className="vsm:text-base md:text-xl CustomizeFontH flex justify-center px-2">
            {data.title}
          </h3>
          ...
          <p className="text-gray-700 md:text-xs xl:text-base	text-justify px-4">
            {data.description.length > 75
              ? `${data.description.substring(0, 70)}... see more`
              : data.description}
          </p>
          ...
          <div className="flex items-center justify-center">
            <button className="bg-[#9747FF] text-white px-4 py-2 rounded-md hover:bg-purple-600">
              Know More{" "}
            </button>
          </div>
        </div>
      ...
      <div
        className={`shadow-2xl shadow-purple-300 xl:hidden vsm:flex vsm:flex-col vsm:my-6 lg:my-0 md:flex ${
          isEven ? "lg:flex-row-reverse" : "lg:flex-row"
        } xl:flex-row items-center justify-center`}
      >
        <div className="relative flex">
          <img
            className={`vsm:w-[300px] md:w-[300px] lg:w-auto lg:h-[350px] vsm:rounded-t-lg  ${
        ...
        <div
          className={`bg-white vsm:w-[300px] md:w-[300px] lg:h-[350px] vsm:p-6 md:p-4 lg:w-1/2 vsm:rounded-b-lg lg:rounded-none ${
