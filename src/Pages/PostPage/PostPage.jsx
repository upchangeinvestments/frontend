  ...
  return (
    <div className="">
      <Helmet>
        ...
        <meta name="description" content="Real Estate listed projects description" />
      ...
      <div className="flex flex-col items-center justify-center relative font-['Playfair-Display'] w-[100%]">
        ...
        {shareModal && (
          <div className="w-full h-full flex items-center justify-center flex-col z-[100] fixed inset-0 overflow-hidden">
            ...
            <div className="bg-white rounded-xl z-10 p-4 w-[90%] md:w-[50%] relative flex flex-col items-center justify-center">
              ...
              <p className="text-xl text-center uppercase font-bold">Share this post</p>
        ...
        <div className="w-[100%] mx-auto">
          <div className="PostPage">
            ...
            <div className="FontLinikSans flex items-center justify-center relative w-full">
              <div className="flex justify-center items-start h-full relative w-[100%]">
                <div className="relative flex flex-col w-[100%]">
                  ...
                  <div ref={bgRef} className="bg-gradient-to-r from-[#2a235a] to-[#150d2b] flex items-center justify-center flex-col relative">
                    <p className={`text-2xl md:text-3xl lg:text-5xl flex items-center justify-center text-center text-white tracking-widest p-4 mb-4 mt-2 lg:mb-12 lg:p-6 font-['Playfair-Display'] font-bold`}>{data.companyName}</p>
        ...
        <div className="vsm:w-[90%] mx-auto md:w-full max-w-7xl my-12 text-white">
          ...
          <div className="w-[90%] mx-auto flex items-center justify-center flex-col-reverse lg:flex-row gap-2 lg:gap-6 mb-12">
            <div className="flex items-center justify-center flex-col text-black lg:basis-[70%]">
              <div className="flex items-center justify-start w-full">
                <p className="uppercase font-bold text-2xl my-2 w-full text-center">Overview</p>
              </div>
          ...
          <div className="w-[90%] mx-auto flex flex-col gap-y-4 md:grid md:grid-cols-3 md:gap-6 h-full my-6">
            <div className="relative bg-gradient-to-r from-[#2A235A] to-[#150D2B] py-6 gap-2 rounded-lg flex items-center justify-start flex-col text-center">
              <p className="text-2xl font-bold text-center my-1 uppercase">Minimum Investment</p>
              <p className="text-[#A26CF6] text-3xl font-bold">USD  {formatMinInvestment(data.minInvestment) ? formatMinInvestment(data.minInvestment) : data.Investment}</p>
            </div>

            <div className="relative bg-gradient-to-r from-[#2A235A] to-[#150D2B] py-6 gap-2 rounded-lg flex items-center justify-start flex-col text-center">
              <p className="font-bold text-2xl text-center my-1 uppercase py-2">Company Age</p>
              <p className="text-[#A26CF6] text-3xl font-bold">{data.age} years</p>
            </div>

            <div className="relative bg-gradient-to-r from-[#2A235A] to-[#150D2B] py-6 gap-2 rounded-lg flex items-center justify-start flex-col text-center">
              <p className="font-bold text-2xl text-center my-1 uppercase py-2">Risk Type</p>
              <p className="text-[#A26CF6] text-3xl font-bold">{data.riskLevel}</p>
            </div>

            <div className="relative bg-gradient-to-r from-[#2A235A] to-[#150D2B] py-6 gap-2 rounded-lg flex items-center justify-start flex-col text-center">
              <p className="font-bold text-2xl text-center my-1 uppercase py-2">Asset Type</p>
              <p className="text-[#A26CF6] text-3xl font-bold">Multifamily</p>
            </div>
            <div className="relative bg-gradient-to-r from-[#2A235A] to-[#150D2B] py-6 gap-2 rounded-lg flex items-center justify-start flex-col text-center">
              <p className="font-bold text-2xl text-center my-1 uppercase py-2">Markets</p>
              <p className="text-[#A26CF6] text-2xl font-bold flex-wrap">Dallas, TX | Las Vegas, NV | Greenville, SC</p>
            </div>
            <div className="relative bg-gradient-to-r from-[#2A235A] to-[#150D2B] py-6 gap-2 rounded-lg flex items-center justify-start flex-col text-center">
              <p className="font-bold text-2xl text-center my-1 uppercase py-2">Investment Type</p>
              <p className="text-[#A26CF6] text-3xl font-bold">Value-add</p>
            </div>
          </div>
          ...
          <div className="w-[90%] mx-auto flex items-center justify-center flex-col lg:flex-row gap-6 h-full my-4 ">
            <div className="flex items-start justify-left lg:basis-[70%] flex-col">
              ...
              <div className="mb-4 text-black">
                <p className="text-xl font-bold uppercase my-2">Investment Strategy</p>
              ...
              <div className="mb-4 text-black">
                <p className="text-xl font-bold uppercase my-2">Redemption Policy</p>
                <ul className="list-disc list-inside space-y-2 text-lg">
              ...
              <div className="text-black">
                <p className="text-xl font-bold uppercase my-2">Management Fees Analysis </p>
                <ul className="list-disc list-inside space-y-2 text-lg">
            ...
            <div className="flex items-center justify-between lg:basis-[30%] flex-col text-black gap-y-12">
              ...
              <div className="flex items-center justify-center flex-col gap-y-2">
                ...
                <p className="text-lg text-center">Explore Investment Opportunity</p>
                <div className="flex items-center justify-center">
                  {!isLaptop &&
                    <div id="returnRates"></div>
                  }
          ...
          <div className="w-[90%] mx-auto py-8">
            <p className="font-bold text-2xl text-black uppercase mb-4">Historical Return Rates</p>
          ...
          <div className="container items-center justify-center flex flex-col w-full md:w-[90%] mx-auto xl:max-w-6xl">
            <div className=" flex flex-col items-center justify-center text-black ">
              <div className="mb-4 text-black">
                <p className="text-xl font-bold uppercase my-2">Summary</p>
            ...
            <div className="bg-gradient-to-r from-[#2A235A] to-[#150D2B] rounded-lg my-4 p-6 w-full xl:max-w-6xl" >
              <p className="font-bold uppercase text-2xl text-center my-1">contact Management</p>
              <div className="flex items-center justify-center flex-col text-lg md:flex-row gap-x-24 py-6 gap-y-12">
          ...
          <div className="w-[100%] mx-auto -ml-4 my-6 xl:ml-0">
            <div className="font-bold uppercase text-black flex items-center justify-center ml-4 text-2xl my-4">
