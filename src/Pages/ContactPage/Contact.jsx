...
function ContactForm() {
  ...
  return (
    <div className="font-['Playfair-Display'] w-full md:mx-auto md:px-12 pb-12 -mt-[270px] md:-mt-[170px] lg:-mt-[260px] xl:-mt-[330px]">
      <div className="block lg:max-w-7xl mx-auto r vsm:py-[20px]  lg:px-6 lg:py-12  md:py-8 md:px-10 -mt-[120px] ">
        <div className=" text-black grid relative vsm:grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2">
          ...
          <div className="vsm:mt-[30px] vsm:py-4 vsm:px-4 mx-4 sm:mt-[50px] sm:px-6 md:mt-[40px] md:mb-6 md:mx-0 lg:mx-4 lg:mt-0 md:col-span-2 lg:col-span-1 md:px-3 lg:mb-0 bg-gradient-to-r from-[#6e30a7] to-purple-300 rounded-lg  flex flex-col items-center justify-center">
            ...
            <form onSubmit={handleSubmit} className=" rounded vsm:p-4 md:px-8 md:pt-6 w-full" >
              <div className="mb-4">
                <label
                  htmlFor="firstName"
      ...
      <div className="rounded-lg max-w-7xl vsm:mx-4 md:mx-auto mt-[30px]  px-6 py-2 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] bg-white/20  md:px-10  backdrop-blur-xl">
        <Faq class="w-full" />
      </div>
    </div>
  );
