...
function ContactForm() {
  ...
  return (
    <div className="container mx-auto md:px-12">
      ...
      <div className="rounded-lg mt-[80px] bg-gradient-to-b from-white/30  to-[#c7b3ee] bg-opacity-10 px-6 py-12 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)]  md:py-8 md:px-10 -mt-[100px] backdrop-blur-[30px]">
        <Faq class="w-full" />
      </div>
    </div>
  );
