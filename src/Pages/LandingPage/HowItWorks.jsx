...
const HowItWorks = () => {
  ...
  return (
    <div className="grid vsm:grid-cols-1 md:grid-cols-2 vsm:mx-6 lg:mx-12 vsm:gap-8 lg:gap-20 vsm:mb-12">
      ...
      <div className="flex flex-col vsm:backdrop-blur-3xl vsm:px-4 vsm:py-4 md:px-6 lg:backdrop-blur-none lg:bg-transparent vsm:rounded-lg vsm:gap-y-4 md:gap-2 lg:gap-6 w-[100%] md:w-[110%] lg:w-[95%] items-left justify-center">
        <div className="flex flex-row items-center gap-4">
          ...
          <div className="z-40  font-['Playfair-Display']">
            <div className="text-xl font-bold YesevaFont">Explore</div>
            ...
            <div className="text-lg	text-justify text-wrap	">
              ...
              <span className="text-purple-600 font-bold">companies</span> to further
        ...
        <div className="flex flex-row items-center gap-4 ">
          ...
          <div className="font-['Playfair-Display']">
            <div className="text-xl font-bold YesevaFont">Invest</div>
            <div className="text-lg	text-justify text-wrap	">
              Invest with our vetted onboarded companies in the world of{" "}
              <span className="text-purple-600 font-bold">Real Estate </span>{" "}
              based on your{" "}
              <span className="text-purple-600 font-bold">Financial Goals</span>
            </div>
          </div>
        </div>
        <hr />
        <div className="flex flex-row items-center gap-4 overflow-y-hidden">
          ...
          <div className="font-['Playfair-Display']">
            <div className="text-xl font-bold YesevaFont">Strengthen Portfolio</div>
            <div className="text-lg	text-justify text-wrap	">
              Once <span className="text-purple-600 font-bold">Invested</span>,
              you will receive your period/terms payout. Sit back and earn a
              stable passive income and watch your{" "}
              <span className="text-purple-600 font-bold">portfolio grow</span>!
            </div>
          </div>
        </div>
      </div>
