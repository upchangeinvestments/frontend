    ...
    return (
        <div className="flex items-center justify-center">
            <div className="relative bg-white rounded-lg w-[90%] md:w-[70%] flex items-center justify-center">
                <div className="xl:w-[21rem] rounded-lg shadow-lg  font-['Playfair-Display'] border-2 border-purple-600">
                    <div className={`px-4 pt-2 text-center flex items-center justify-center flex-col`}>
                        ...
                        <h2 className="text-lg font-bold whitespace-nowrap text-ellipsis text-black my-2">{data.companyName}</h2>
                    ...
                    <div className="flex flex-wrap mb-[3rem]">
                        <div className="w-1/2 p-2 text-center">
                            ...
                            <span className="block text-sm text-gray-600 whitespace-nowrap">Min Investment</span>
                        </div>
                        <div className="w-1/2 p-2 text-center">
                            <span className="block text-lg font-bold text-purple-700">{data.feeStructure}%</span>
                            <span className="block text-sm text-gray-600 whitespace-nowrap">Management Fees</span>
                        </div>
                        <div className="w-1/2 p-2 text-center">
                            <span className="block text-lg font-bold text-purple-700">{data.aum}</span>
                            <span className="block text-sm text-gray-600 whitespace-nowrap">Past Distribution</span>
                        </div>
                        <div className="w-1/2 p-2 text-center">
                            <span className="block text-lg font-bold text-purple-700">{data.classType} </span>
                            <span className="block text-sm text-gray-600 whitespace-nowrap">Class Type</span>
                        </div>
                        <div className="w-1/2 p-2 text-center">
                            <span className="block text-lg font-bold text-purple-700">{data.age} years</span>
                            <span className="block text-sm text-gray-600 whitespace-nowrap">Company Age</span>
                        </div>
                        <div className="w-1/2 p-2 text-center">
                            <span className="block text-lg font-bold text-purple-700">{data.historicalReturnRates}%</span>
                            <span className="block text-sm text-gray-600 whitespace-nowrap">Return Range</span>
                        </div>
                    </div>
