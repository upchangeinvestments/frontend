...
function FeaturedProject() {
  ...
  return (
    <div className="grid grid-row gap-8 md:w-[100%] md:h-[500px] lg:h-[700px] vsm:mt-[150px] md:-mt-[120px] lg:-mt-[270px] xl:-mt-[270px] vsm:mb-[250px] md:mb-[270px] lg:mb-[130px] 2xl:mb-[190px]">
