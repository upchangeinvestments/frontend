  ...
  return (
    <div id="HowItWorks" className="md:mx-12 lg:mx-12 xl:mx-24">
      <div className="vsm:bg-white/20 vsm:backdrop-blur-3xl md:backdrop-blur-none md:bg-transparent vsm:py-4 vsm:mx-6 rounded-lg">
        <h1 className="hidden md:flex justify-center font-bold font-['Playfair-Display'] w-full mt-2 vsm:text-2xl md:text-3xl">
          <span className="text-purple-600">CHOOSE THE FIRM&nbsp;</span> - NOT JUST THE DEAL
        </h1>
        <h1 className="flex items-center justify-center font-bold font-['Playfair-Display'] w-full mt-2 vsm:text-2xl md:text-3xl md:hidden">
          <span className="text-center text-purple-600">CHOOSE THE FIRM <span className="text-black">- NOT JUST THE DEAL</span></span>
        </h1>
          ...
          <div className="lg:flex items-center justify-between">
            ...
            <div className="mt-[30px] w-[100%] md:w-[50%]">
              <div className="flex flex-col vsm:backdrop-blur-3xl vsm:px-4 vsm:py-4 md:px-6 lg:backdrop-blur-none lg:bg-transparent vsm:rounded-lg vsm:gap-y-4 md:gap-2 w-[100%] md:w-[110%] lg:w-[95%] items-left justify-center">
                <div className="flex flex-row items-center gap-4 mx-auto w-full md:w-[80%]">
                  <div className="">
                    <svg
                      className=" h-10 w-10"
        ...
        <div className="w-full my-4">
          <p className="text-xl w-[90%] mx-auto text-justify font-['Playfair-Display']">We’ve built a aggregator platform that centralizes verified real estate investment firms into one seamless experience—eliminating fragmented
