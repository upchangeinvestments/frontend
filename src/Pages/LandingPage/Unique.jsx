...
function Unique() {
  ...
  return (
    <div className="flex items-center w-[80%] flex-col mx-auto my-8">
      <h1 className="font-bold text-5xl YesevaFont flex flex-col items-center justify-center uppercase">
        <p>Discover the Power of</p>
        <p className="text-purple-600">Choice</p>
      </h1>
      <p className="font-['Playfair-Display'] text-2xl mt-4 text-center">We provide a comprehensive suite of reputable real estate investment firms under one roof. Our aggregator platform facilitates seamless comparison,
