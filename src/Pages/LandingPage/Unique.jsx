...
function Unique() {
  ...
  return (
    <div className="mx-auto p-4">
      ...
      <div className={`px-4 vsm:grid vsm:gap-4 md:mx-24 ${navigator.userAgent.indexOf('iPad') > -1 ? '-gap-[5px]' : ''} lg:gap-[170px] xl:gap-[150px] lg:mx-20 xl:mx-40 lg:mt-[10px] lg:flex lg:items-center lg:justify-end xl:justify-center iPadAlignment`}>
