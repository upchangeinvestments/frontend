...
function Unique() {
  ...
  return (
    <div className="flex items-center w-[80%] flex-col mx-auto my-8">
      ...
      <p className="font-['Playfair-Display'] text-xl md:text-2xl mt-4 text-center">We provide a comprehensive suite of reputable real estate investment firms under one roof. Our aggregator platform facilitates seamless comparison,
