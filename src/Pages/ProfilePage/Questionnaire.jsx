    ...
    return (
        <div className="bg-white/20 backdrop-blur-sm rounded-lg flex flex-col justify-center items-center py-2 shadow-lg hover:shadow-xl container mx-auto m-4 relative" >
            <div className="flex vsm:flex-col lg:flex-row w-full mx-16 lg:items-center lg:justify-center">
                <div className="vsm:w-full vsm:px-6  lg:w-6/12 flex items-center justify-center m-4 mx-auto">
                    {loadQuiz()}
                </div>
            </div>
            <div className="mt-4 absolute bottom-8 right-8">
                <button onClick={QuizHandler} className="bg-purple-500 hover:bg-purple-600 text-white font-bold py-2 px-4 rounded">
                    Save Changes
                </button>
            </div>
        </div >
