...
const Profile = () => {
  ...
  return (
    <div className="font-['Playfair-Display'] vsm:mt-[20px] vsm:p-[16px] sm:mt-[20px] sm:p-[18px] md:mt-[40px] lg:mt-[40px] lg:p-[15px] w-[90%] backdrop-blur-xl rounded-lg shadow-2xl relative">
      {tabContent && (
