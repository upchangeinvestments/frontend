    ...
    <div className="w-full">
      <div className="aboutMain  font-['Playfair-Display'] text-white">
        ...
        <div className="h-[85vh] flex items-center justify-center">
          <p className="uppercase font-['Playfair-Display'] lg:text-5xl xl:text-6xl text-purple-600 vsm:text-4xl md:text-5xl lg:-mt-[350px] xl:-mt-[430px] mx-auto lg:ml-[60%]">
            Profile
          </p>
        </div>
        <div className="">
          <div className="flex vsm:mb-[130px] md:gap-[90px] lg:mb-[190px] xl:mb-[240px] p-2 lg:gap-[90px] absolute bottom-0 w-full vsm:gap-4 items-center justify-center ">
            {tabs.map((tab, index) => (
              <button
                key={index}
                className={`py-2 vsm:px-2 lg:px-4 vsm:text-sm msm:text-lg sm:text-xl md:text-2xl lg:text-[28px] text-purple-600  focus:outline-none ${activeTab === index
