...
function SearchBox(props) {
    return (
        <div className="flex items-center justify-center bg-black opacity-[0.6] w-full p-4">
            <form className="w-[60%] ">
                ...
                <div className="relative flex items-center">
                    ...
                    <input type="search" id="default-search" className="outline-none block w-full p-4 ps-12 text-base rounded-full bg-gray-50" placeholder="Search..." required />
